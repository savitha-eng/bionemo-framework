...
- `run_configs/paper_llava_obelics_8gpu.sh`: local/cluster shell launcher.
...
- `stores/llava_next_mistral_7b_obelics100k/layer16/`
- `ckpts/llava_next_mistral_7b_L16_exp16_k128_obelics100k/checkpoint_final.pt`
- `out/llava_next_mistral_7b_L16_obelics100k_image-text.json`

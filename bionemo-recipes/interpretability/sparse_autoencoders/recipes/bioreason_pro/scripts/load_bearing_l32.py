...
store="/data/savithas/phase3_subset_8k/L28-32_subset8k"; layer=32; STRIDE=8
tl=pq.read_table(f"{store}/token_labels.parquet")
band=np.array(tl.column("position_type").to_pylist(),dtype=object)
ck=torch.load("/data/savithas/phase3_full/sae-l32-exp16-balanced/checkpoint_final.pt",map_location="cpu")
...
np.savez("/data/savithas/phase3_full/load_bearing_l32.npz",ma_protein=ma["protein"],ma_text=ma["text"],dnorm=dnorm)
